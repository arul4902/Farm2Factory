      ...
      <main className="App-main">
        <HeroSection className="hero-section">
          <video className="video-background" autoPlay loop muted>
            <source src="/6688511-uhd_3840_2160_30fps.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
          <HeroText className="hero-text">
            <Typography variant="h2" component="h1">Farm2Factory</Typography>
            <Typography variant="h5" component="p">Hello Farmers! Let's Transform Waste into Opportunity.</Typography>
        ...
        <section className="shop-by-category1">
