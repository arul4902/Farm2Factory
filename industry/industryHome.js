...
const pillars = [
  ...
  },
  {
    ...
    description: 'At our Farms, we ensure that we remain updated with the latest health norms. We even followed updated FSSAI norms meant to ensure safety during the global COVID pandemic.'
  },
  {
    icon: faUserFriends,
    title: 'Farmer-led initiative',
    description: 'Our Farms is an initiative fully led and managed by farmers who have complete understanding of the problems faced by small-landholding farmers.'
  }
];
      ...
      <main className="App-main">
        <HeroSection className="hero-section">
          <video className="video-background" autoPlay loop muted>
            <source src="/4686755-uhd_3840_2160_24fps.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
          <HeroText className="hero-text">
            <Typography variant="h2" component="h1">Farm2Factory</Typography>
            <Typography variant="h5" component="p">Welcome, Industries! Turning Waste into Valuable Resources</Typography>
            <Button
              variant="contained"
        ...
        <section className="shop-by-category2">
